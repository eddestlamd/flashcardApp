...
public class FlashcardController {
   ...
   RestTemplate restTemplate;
    ...
    @PostMapping("/save")
    public String save(@ModelAttribute Flashcard flashcard, @ModelAttribute Topic topic){
       //
        ...
        topic = restTemplate.getForObject("http://localhost:8081/api/topic/" + topic.getId(), Topic.class);
        flashcard.setTopic(topic);
...
//WORKING
    ...
    public String add(Model model) {
        ...
        ArrayList<Topic> topics = restTemplate.getForObject("http://localhost:8081/api/topic/all", ArrayList.class);
        model.addAttribute("topics", topics);
